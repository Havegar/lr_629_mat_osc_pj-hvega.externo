...
complete = pd.read_csv('artefactos/Oscuridad/Sociedades_oscuridad_completa.csv', delimiter=',')
society_all= pd.read_csv('artefactos/Oscuridad/Sociedades_oscuridad_actualizada.csv', delimiter=',')
...
get_ipython().system('jupyter nbconvert --to html reporte_oscuridad.ipynb --stdout > "artefactos/Oscuridad/reporte_oscuridad.html"')
